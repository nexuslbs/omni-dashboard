...
import { renderHooks, renderHookDetail } from "../pages/hooks";
...
import { renderToolsets } from "../pages/toolsets";
...
const routes: Route[] = [
  ...
  { name: "toolsets", handler: renderToolsets },
...
const paramRoutes: ParamRoute[] = [
  ...
  { prefix: "hooks/", handler: renderHookDetail },
];
